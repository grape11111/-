...
%>
				<td><a href='${pageContext.request.contextPath}/Product_detail?pm.code=<%= list.get(i).getCode()%>' target='contain'><%= list.get(i).getName()%></a></td>					
<%			   if((i+1)%5==0) { %>
				  </tr><tr>
<%			   }
			}
 ...
 %>
			...
			<form action="${pageContext.request.contextPath}/Product_query" method="post">
